                ...
                <div className="w-[45%] flex flex-col justify-between gap-y-9 ">
                    <div className="">
                        ...
                        <div className="flex items-center gap-x-4  py-5 group">
                            ...
                            <button className='font-secondary   font-normal py-[11px] px-[17px] rounded-[30px] bg-white/10 border border-white/10  text-[12 px] text-white  transition-transform duration-300 group-hover:bg-purple-800 '>Send Message</button>
                        </div>
                    </div>
                    <div className=" flex flex-col  gap-y-2.5  ">
