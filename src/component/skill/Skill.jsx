    ...
    return (
        <div id='Skill' className=' py-[25px] md:py-[107px] md:flex justify-center items-center '>
            <div className=" md:flex md:justify-between  pt-[30px] md:pt-[74px] bg-white/10 rounded-2xl  px-[20px] md:px-[90px]  pb-8 md:pb-0 ">
                ...
                {/* right__part  */}
                <div className="md:w-[60%] flex flex-col gap-y-[40px]  ">
                    {/* right__top__part */}
                    <div className=" flex flex-col  justify-center gap-y-5 md:gap-y-0  md:flex-row md:justify-between md:gap-x-[20px] ">
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            ...
                            <div className="relative mb-[5px] py-[8px] px-[38px] rounded bg-black overflow-hidden group">
                                {/* Purple fill background */}
                                <div className="absolute top-0 left-0 h-full w-0 bg-purple-800 transition-all duration-700 group-hover:w-[75%]"></div>
                        ...
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            ...
                            <div className="relative mb-[5px] py-[8px] px-[38px] rounded bg-black overflow-hidden group">
                                {/* Purple fill background */}
                                <div className="absolute top-0 left-0 h-full w-0 bg-purple-800 transition-all duration-700 group-hover:w-[95%]"></div>
                        ...
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            ...
                            <div className="relative mb-[5px] py-[8px] px-[38px] rounded bg-black overflow-hidden group">
                                {/* Purple fill background */}
                                <div className="absolute top-0 left-0 h-full w-0 bg-purple-800 transition-all duration-700 group-hover:w-[90%]"></div>
                        ...
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            ...
                            <div className="relative mb-[5px] py-[8px] px-[38px] rounded bg-black overflow-hidden group">
                                {/* Purple fill background */}
                                <div className="absolute top-0 left-0 h-full w-0 bg-purple-800 transition-all duration-700 group-hover:w-[85%]"></div>
                    ...
                    <div className="flex flex-col  justify-center gap-y-5 md:gap-y-0  md:flex-row md:justify-between md:gap-x-[20px] ">
                        ...
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            ...
                            <div className="relative mb-[5px] py-[8px] px-[38px] rounded bg-black overflow-hidden group">
                                {/* Purple fill background */}
                                <div className="absolute top-0 left-0 h-full w-0 bg-purple-800 transition-all duration-700 group-hover:w-[80%]"></div>
