        ...
        <div className='py-[107px] '>
            <div className="flex justify-between  py-[74px]  bg-white/10 rounded-2xl px-[90px] ">
                <div className="w-[30%] py-[125px]  ">
                    ...
                    <h3 className='ont-primary font-bold text-[32px]  text-white '>Let’s Explore Popular <samp className='text-[#98c45d]'>Skills & Experience</samp> </h3>
                    ...
                    <div className="pt-[87px] flex items-center gap-x-2  ">
                        <p className='font-primary  font-normal  text-[16px] text-white'>Learn More</p>
                        <div className=" flex justify-center w-[49px] h-[49px] rounded-full items-center bg-black text-white ">
                ...
                <div className="w-[60%] flex flex-col  gap-y-[40px]  ">
                    <div className="flex justify-between gap-x-[20px] g"> 
                        ...
                        <div className="flex flex-col items-center px-[10px] pb-[8px] pt-[27px] rounded-[20px] bg-[#131313] group hover:translate-y-[-5px] transition-transform duration-300 group-hover:border-2 group-hover:border-purple-800  ">
                            <a className='text-white transition-transform duration-30 group-hover:text-purple-800 text-[60px] mx-auto group-hover:animate-bounce group-hover:text-primary' href=""><AiTwotoneHtml5 size ={40}  /></a>
