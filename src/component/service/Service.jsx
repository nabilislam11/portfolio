  ...
  return (
    <div id='Service' className='pt-[103px] pb-[126px] '>
      ...
      <div className= " flex justify-around pb-24 ">
           <div className=" group   transition-transform duration-300 flex items-center justify-between bg-[#1F1F1F] rounded-[20px] py-[35px] px-[20px] gap-x-[102px]  hover:border-2 hover:border-purple-800 " >
        ...
        <div className="w-[49px] h-[49px] bg-black transition-transform duration-300 group-hover:bg-purple-800 rounded-full flex justify-center items-center text-white">
          <FaCode size={20} />
           ...
           <div className=" group transition-transform duration-300 flex items-center justify-between bg-[#1F1F1F] rounded-[20px] py-[35px] px-[20px] gap-x-[102px]  hover:border-2 hover:border-purple-800 " >
        <div className="gap-y-2">
          <h3 className='font-secondary  font-bold text-[32px] text-white'>React Development</h3>
      ...
      <div className="flex justify-around ">
           <div className="flex items-center justify-between bg-[#1F1F1F] rounded-[20px] py-[35px] px-[20px] gap-x-[102px] group transition-transform duration-300 hover:border-2 hover:border-purple-800 " >
        <div className="gap-y-2">
          <h3 className='font-secondary  font-bold text-[32px] text-white'>Powerful Backend Dev</h3>
        ...
        <div className="w-[49px] h-[49px] bg-black rounded-full flex justify-center items-center text-white  group-hover:bg-purple-800">
          <FaCode size={20} />
           ...
           <div className="flex items-center justify-between bg-[#1F1F1F] rounded-[20px] py-[35px] px-[20px] gap-x-[102px] group  transition-all   duration-300  hover:border-2 hover:border-purple-800 " >
        <div className="gap-y-2">
          <h3 className='font-secondary  font-bold text-[32px] text-white'>Modern and smart DataBase</h3>
